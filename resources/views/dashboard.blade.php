                    ...
                    <div id="content">
                        <div class="col">
                            <div class="row" style="align-items: center;">
                                ...
                                <div class="col">
                                    <div class="col">
                                        <span><h2 class="fw-bolder"><strong>{{ Auth::user()->name }}</strong></h2></span>
                ...
                <div class="card-body">
                    ...
                    <div class="col mb-4">
                        ...
                        <div class="row" style="align-items: center;">
                            <div class="col">
                                <div class="col mt-2">
                                    <span style="color: #AFAFAF;">{{ Auth::user()->name }} baru saja melakukan kegiatan user</span>
                                    <span><h2 class="fw-bolder"><strong>Nama Kegiatan</strong></h2></span>
